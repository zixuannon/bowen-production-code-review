...
class StudentFeeAssignmentMigrationRunnerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        Config::set('finance_release.student_fee_assignment_canary', 'SCH202615');
    ...
    {
        $this->assertSame(['SCH202615','SCH202616','SCH202619','SCH202620','SCH202621','SCH202631','SCH202632'], array_keys(MigrateStudentFeeAssignmentSchema::PRODUCTION_TENANTS));
    ...
    public function test_default_is_zero_write_and_demo_unknown_and_database_names_are_denied(): void
    {
        ...
        $this->artisan('finance:migrate-student-fee-assignments', ['--tenant'=>[$this->trusted['SCH202615']]])->assertExitCode(1);
    ...
    public function test_remaining_schools_are_refused_until_canary_is_schema_and_history_verified(): void
    {
        ...
        $this->artisan('finance:migrate-student-fee-assignments', ['--tenant'=>['SCH202615'],'--execute'=>true])->assertExitCode(0);
        $this->assertTrue($this->complete($this->trusted['SCH202615']));
        $this->assertSame(MigrateStudentFeeAssignmentSchema::MIGRATIONS, $this->migrations($this->trusted['SCH202615']));
    ...
    {
        $this->on($this->trusted['SCH202615'], fn () => Schema::connection('school')->create('student_fee_assignments', fn ($table) => $table->increments('id')));
        $this->artisan('finance:migrate-student-fee-assignments', ['--tenant'=>['SCH202615']])->assertExitCode(1);
