<div class="card mb-3 border-primary" data-operating-school-banner>
    <div class="card-body d-flex flex-wrap align-items-center justify-content-between">
        <div>
            ...
            <span class="badge badge-info ml-2">{{ __('Read-only') }}</span>
            <p class="mb-0 small text-muted">{{ __('Central identity is retained. Fund Account visibility follows the mapped tenant identity and existing scope.') }}</p>
        </div>
