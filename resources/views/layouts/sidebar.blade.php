                    ...
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item">
                            <details class="central-finance-sidebar-group">
                                ...
                                <ul class="nav flex-column sub-menu">
                                    ...
                                    <li class="nav-item"><a class="nav-link {{ request()->routeIs('central-finance.other-income.*') ? 'active' : '' }}" href="{{ route('central-finance.other-income.index') }}">{{ __('其他收入') }}</a></li>
                        ...
                        <li class="nav-item">
                            <details class="central-finance-sidebar-group">
                                ...
                                <ul class="nav flex-column sub-menu">
                                    <li class="nav-item"><a class="nav-link {{ request()->routeIs('central-finance.expenses.*') ? 'active' : '' }}" href="{{ route('central-finance.expenses.index') }}">{{ __('支出记录') }}</a></li>
                                    <li class="nav-item"><a class="nav-link {{ request()->routeIs('central-finance.reimbursements.*') ? 'active' : '' }}" href="{{ route('central-finance.reimbursements.index') }}">{{ __('报销申请') }}</a></li>
