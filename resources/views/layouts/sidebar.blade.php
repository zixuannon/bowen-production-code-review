                        ...
                        <li class="nav-item">
                            <details class="central-finance-sidebar-group">
                                ...
                                <ul class="nav flex-column sub-menu">
                                    ...
                                    <li class="nav-item"><a class="nav-link {{ request()->routeIs('central-finance.other-income.*') ? 'active' : '' }}" href="{{ route('central-finance.other-income.index') }}">{{ __('收入') }}</a></li>
