...
<div class="content-wrapper central-finance-page">
    ...
    <div class="card"><div class="card-body"><div class="alert alert-info mb-4"><strong>{{ $profile->student_name }}</strong><span class="d-block">{{ $receivable->description }}</span><span class="d-block mt-1">{{ __('Outstanding') }}: <strong>{{ number_format($receivable->amount_due-$receivable->amount_paid,2) }} {{ $receivable->currency }}</strong></span></div>
