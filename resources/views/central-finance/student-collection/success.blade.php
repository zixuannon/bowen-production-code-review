...
@section('title', $schoolFinanceFacade ? __('School Finance') : __('Payment Collected'))
...
<div class="content-wrapper central-finance-page">
    <x-central-finance.page-header :title="__('Payment collected')" :school="$school" :status="$cutoverStatus" :eyebrow="__('Student Finance')" :school-finance-facade="$schoolFinanceFacade" />
