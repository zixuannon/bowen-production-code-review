    ...
    <div class="row">
        <div class="col-lg-7 mb-3">
            <div class="card"><div class="card-body">
                ...
                <hr>
                <dl class="row mb-0"><dt class="col-sm-4">{{ __('Status') }}</dt><dd class="col-sm-8">{{ $document->status }}</dd><dt class="col-sm-4">{{ __('Due date') }}</dt><dd class="col-sm-8">{{ $document->due_date?->format('Y-m-d') ?: '—' }}</dd><dt class="col-sm-4">{{ __('Tenant source') }}</dt><dd class="col-sm-8">{{ $document->source_type }} #{{ $document->source_id }}</dd></dl>
            </div></div>
        </div>
